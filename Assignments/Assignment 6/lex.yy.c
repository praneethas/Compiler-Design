...
YY_RULE_SETUP
#line 15 "token.l"
{strcpy(yylval.value,yytext);return INTEGER;}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 16 "token.l"
{strcpy(yylval.value,yytext);return IDENTIFIER;}
	YY_BREAK
case 5:
